...
HOUDINI_TOOLS=${MEDIA_PROJECT_DIR}/pipe/tools/hou/
...
export HOUDINI_PATH=${HOUDINI_PATH}:${HOUDINI_TOOLS}:${MEDIA_PROJECT_DIR}"/production;&":${MEDIA_PROJECT_DIR}"/production/hda;&"
