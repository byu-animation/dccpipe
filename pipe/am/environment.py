...
class Department:
    ...
    ACTOR_EXPORT_DEPARTMENTS = [MODEL, RIG]
    PROP_EXPORT_DEPARTMENTS = [MODEL]
    SET_EXPORT_DEPARTMENTS = [MODEL]
    SHOT_EXPORT_DEPARTMENTS = [ANIM, MODEL]

    SHOT_DEPTS = [ANIM, CAMERA, CFX, CLOTH, COMP, FX, HAIR, LAYOUT, LIGHTING, RENDER, RIB_ARCHIVE]
    TOOL_DEPTS = [HDA]
    CROWD_DEPTS = [CYCLES]

    ALL = [ANIM, ASSEMBLY, CAMERA, CFX, CLOTH, COMP, CYCLES, DESIGN, FX, HAIR, HDA, LAYOUT, LIGHTING, MATERIAL, MODEL, MODIFY, RENDER, RIB_ARCHIVE, RIG, TEXTURE]
